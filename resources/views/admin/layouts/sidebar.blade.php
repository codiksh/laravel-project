...
<aside class="main-sidebar elevation-4 sidebar-dark-primary">
    <!-- Brand Logo -->
    <a href="{{ route('home') }}" class="brand-link navbar-primary text-center">
        <span class="logo-mini"><strong>DC</strong></span>
        <span class="brand-text font-weight-bold">{{ env('APP_NAME', 'Dechcept') }}</span>
    </a>
    <!-- Sidebar -->
    <div class="sidebar">
        <!-- Sidebar Menu -->
